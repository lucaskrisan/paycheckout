  ...
  return (
    <div className={containerClass}>
      ...
      <div>
        ...
        <p className={`<p className={`${isRevenue ? "text-3xl" : "text-2xl"} font-bold tracking-tight mt-1.5 ${isRevenue ? "text-white" : "text-primary"}`}> ${isRevenue ? "text-white" : "text-primary"}`}>
          {fmt(animatedValue)}
        </p>
      </div>
