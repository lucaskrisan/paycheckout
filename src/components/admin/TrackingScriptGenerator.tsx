...
${pixelInits}
  ...
  fetch('${checkoutBaseUrl.replace(window.location.origin, '')}' ? '${import.meta.env.VITE_SUPABASE_URL || ''}/functions/v1/facebook-capi' : '${import.meta.env.VITE_SUPABASE_URL || ''}/functions/v1/facebook-capi',{
