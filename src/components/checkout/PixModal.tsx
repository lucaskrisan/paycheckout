    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#00A868] to-[#067D62] px-6 py-5 text-white relative">
              <button
                onClick={onClose}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold">PIX gerado com sucesso!</h2>
                  <p className="text-white/80 text-sm">Escaneie ou copie o código abaixo</p>
                </div>
              </div>
            </div>

            {/* Timer */}
            <div className="flex items-center justify-center gap-2 py-3 bg-[#FFF8E1] border-b border-[#FDE68A]">
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="text-center">
                ...
                <p className="text-3xl font-extrabold text-[#0F1111] mt-1">
              ...
              >
                <div className="w-52 h-52 bg-white border-2 border-[#E5E7EB] rounded-2xl flex items-center justify-center shadow-sm p-2">
                  {qrCodeUrl ? (
